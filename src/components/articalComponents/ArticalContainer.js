...
const ArticalContainer = (props) => {
  return (
    <Link onClick={() => {props.setNavStyle('changedStyle')}} /*to={props.articalPostNumber === "1" ? "/BlogPost1" : "/"} */ id='artical-container' className={props.articalPostNumber === "1" ? "artical-1" : props.articalPostNumber === "2" ? "artical-2" : props.articalPostNumber === "3" ? "artical-3" : ""}>
